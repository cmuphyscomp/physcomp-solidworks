...
3. In the Post Process dialog, find the post-processors field at the top under Configuration Folder.  Click the ellipsis button to open a folder selection dialog.  Select the folder containing this file you are reading (physcomp-solidworks/HSMWorks).
